        ...
        <div class="WTcenter">
            <div id="WTplayer-box" class="WTcontent-box">
                    ...
                    <div class="WT-info">
                        ...
                        <div class="WT-detailed-info">
                            ...
                            <div class="WTdetailed-aux">
                                ...
                                <span class="WTdirector">{{$content->studio}}</span>
                                <br>
                                <span class="WTdirector-caption">Elenco:</span>
                                <span class="WTdirector">{{implode(', ', $cast)}}</span>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <span id="movie-synopsis" class="WT-content-synopsis" style="margin-top:15px;">
                ...
                <div class="WTplayer-aux" style="padding-top: 0;">
                    <div id="WT-actions" class="movie-actions">
                        <div id="WTvisto">
                            <form method="POST" action="{{ route('movie.seen') }}" id="report">
                                @csrf
