        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <div class="text-center">
                    <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="rounded img-circle img-thumbnail" alt="avatar">
            ...
            <div class="col-sm-9">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a data-toggle="tab" href="#history">Viewing History</a>
                    </li>
                    <li>
